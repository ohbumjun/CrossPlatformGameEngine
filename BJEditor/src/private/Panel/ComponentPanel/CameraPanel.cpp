...
void HazelEditor::CameraPanel::DrawCameraComponent(
    Hazel::Component &inputComponent)
{
    /*
	...
	*/
    ...
    Hazel::CameraComponent &component =
        static_cast<Hazel::CameraComponent &>(inputComponent);
    Hazel::SceneCamera &camera =
        const_cast<Hazel::SceneCamera &>(component.GetCamera());
    ...
    if (camera.GetProjectionType() ==
        Hazel::SceneCamera::ProjectionType::Projective)
    {
    ...
    else if (camera.GetProjectionType() ==
             Hazel::SceneCamera::ProjectionType::Orthographic)
    {
...
void HazelEditor::CameraPanel::DrawEditorCamera(
